      ...
      <div class="container-fluid d-flex align-items-center justify-content-between gap-2" style="height:56px">
        ...
        <div class="d-flex align-items-center gap-2">
          <ul class="nav nav-pills d-flex gap-1 mb-0">
            ...
            <li class="nav-item">
              <a class="nav-link py-1 px-2" href="/store-editor/" title="Visual layout & page editor">
                <i class="bi bi-layout-text-sidebar"></i><span class="nav-label ms-1">Templates</span>
              </a>
            </li>
          </ul>
          ${storeUrl ? `
      ...
      <div class="customize-layout" id="customize-layout">
        ...
        <div class="customize-sidebar">
          <div class="customize-sidebar-header d-flex align-items-center justify-content-between">
            ...
            <a href="/store-editor/" class="btn btn-sm btn-outline-secondary py-0 px-2" style="font-size:.7rem" title="Edit page layouts and sections">
              <i class="bi bi-layout-text-sidebar me-1"></i>Templates
            </a>
          </div>
